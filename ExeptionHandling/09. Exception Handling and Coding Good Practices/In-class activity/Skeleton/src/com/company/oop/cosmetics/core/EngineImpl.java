...
public final class EngineImpl implements Engine {
    ...
    private void processCommand(String inputLine) {
        ...
        } catch (InvalidNameLengthException | InvalidBrandLengthException |
                 InvalidCommandException | InvalidUserNotUniqueException |
                 InvalidBrandNotUniqueException | InvalidPriceRangeException |
                 InvalidGenderTypeException | IllegalPriceFormatException |
                 InvalidArgumentCountException | NumberFormatException |
                 InvalidCategoryNotExistException | InvalidProductNotExistException e) {
