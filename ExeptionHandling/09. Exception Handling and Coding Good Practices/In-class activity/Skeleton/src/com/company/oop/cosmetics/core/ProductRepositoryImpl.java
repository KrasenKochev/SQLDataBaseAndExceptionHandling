...
import com.company.oop.cosmetics.exeptions.InvalidCategoryNotExistException;
import com.company.oop.cosmetics.exeptions.InvalidProductNotExistException;
...
public class ProductRepositoryImpl implements ProductRepository {
    ...
    public Product findProductByName(String productName) {
        ...
        throw new InvalidProductNotExistException(String.format(PRODUCT_DOES_NOT_EXIST, productName));
    }
    ...
    public Category findCategoryByName(String categoryName) {
        ...
        throw new InvalidCategoryNotExistException(String.format(CATEGORY_DOES_NOT_EXIST, categoryName));
    }
